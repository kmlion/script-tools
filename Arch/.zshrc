...
zstyle :compinstall filename '/home/kmlion/.zshrc'
alias dodo='sudo shutdown -P 180'
alias rmf='rm -rf'
alias gitecopanierBack='cd /run/media/virtuelram && git clone --depth=1 git@bitbucket.org:devos31/mainframe.git && cd mainframe && mvn spring-boot:run'
...
promptinit
prompt bigfade blue white red blue
